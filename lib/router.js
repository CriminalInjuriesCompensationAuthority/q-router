...
function qRouter(spec) {
    ...
    function updateContext(contextPropertyKey, contextPropertyValue) {
        q[contextPropertyKey] = contextPropertyValue;
    }
    ...
    // function findCascadeIndex_OLD(sectionId) {
    ...
    function setCurrent(currentSectionId, events) {
        ...
        // machine being actively used at this point.
        q.active = true;
    ...
    // function updateTaskStatus(newStatus, taskId = q.id) {
    //     q.status[taskId] = newStatus;
    // }
    ...
    function next(answers, currentSectionId = q.currentSectionId, event = 'ANSWER') {
        // console.log({answers, currentSectionId, event});
        // console.log({isSectionAvailable: isSectionAvailable(currentSectionId)});
        if (!isSectionAvailable(currentSectionId)) {
            return undefined;
        }
        ...
        const events = [];
        if ('actions' in state) {
            events.push(...state.actions);
        }
        // events.push({
        //     type: `${event}__${currentSectionId}`
        // });
        // if (state.actions) {
        ...
        //             // crude status switcher.
        //             // TODO: needs to be abstracted out.
        //             // applicable, notApplicable, etc.
        //             const validTransitions = {
        //                 cannotStartYet: 'incomplete',
        //                 incomplete: 'completed',
        //                 complete: 'incomplete'
        //             };
        //             const actionDestination = action.value;
        //             const currentDestinationStatusValue = q.status[actionDestination];
        //             const newDestinationValue = validTransitions[currentDestinationStatusValue];
        //             if (newDestinationValue !== undefined) {
        //                 updateTaskStatus(newDestinationValue, actionDestination);
        //             }
        //         }

        //         if (action.type === '|checkCascade') {
        //             events.push({
