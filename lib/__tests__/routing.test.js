...
describe('qRouter', () => {
    ...
    it('should overwrite the previous answer when the question is edited', () => {
        ...
        // edit question
        router.next('ANSWER', {
            'section1/q1': 'value of answer 1 edited',
            'section1/q2': 'value of answer 2 edited'
        });

        expect(router.extendedState).toEqual({
            section1: {
                'section1/q1': {value: 'value of answer 1 edited'},
                'section1/q2': {value: 'value of answer 2 edited'}
            }
        });
    });
