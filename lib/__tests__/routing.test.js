...
describe('qRouter', () => {
    ...
    describe('Edit from summary section', () => {
        it('should return to the summary section if the edit has no cascading affect', () => {
            ...
            if (router.current() === 'summary') {
                result = router.next('EDIT', {bQ1: 5}, 'b');
            }
        ...
        describe('Repeating sections', () => {
            it('should return to the summary section if the edit has no cascading affect', () => {
                ...
                if (router.current() === 'summary') {
                    result = router.next('EDIT', {aQ2: 5}, 'a/2');
                }
    ...
    it('should throw if a state has no target that evaluates to true', () => {
        ...
        expect(() => router.next('ANSWER')).toThrowError(rxExpectedError);
    });
    ...
    describe('Operators', () => {
        it('should return true if dateExceedsTwoYearsFromToday', () => {
            ...
            const nextSectionId = router.next('ANSWER', {q1: '2017-02-01T00:00Z'});
        ...
        it('should return false if not dateExceedsTwoYearsFromToday', () => {
            ...
            const nextSectionId = router.next('ANSWER', {q1: '2018-12-01T00:00Z'});
        ...
        it('should return true if dateLessThanEighteenYearsAgo and date entered is less than 18 years ago', () => {
            ...
            const nextSectionId = router.next('ANSWER', {q1: '2015-02-01T00:00Z'});
        ...
        it('should return false if dateLessThanEighteenYearsAgo and date entered is more than 18 years ago', () => {
            ...
            const nextSectionId = router.next('ANSWER', {q1: '1985-02-01T00:00Z'});

            expect(nextSectionId).toEqual('section3');
        });

        it('should return true if dateGreaterThanTwoDays', () => {
            ...
            router.next('ANSWER', {q1: oneDayAgo});
            const nextSectionId = router.next('ANSWER', {q1: 'test string'});

            expect(nextSectionId).toEqual('section3');
        });

        it('should return false if not dateGreaterThanTwoDays', () => {
            ...
            router.next('ANSWER', {q1: threeDaysAgo});
            const nextSectionId = router.next('ANSWER', {q1: 'test string'});
