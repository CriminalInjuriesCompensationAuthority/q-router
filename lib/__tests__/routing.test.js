...
describe('qRouter', () => {
    it('should start at the specified section', () => {
        ...
        expect(router.getCurrentSectionId()).toEqual('section1');
    });
    ...
    describe('Progress management', () => {
        describe('Given the following saved progress ["a", "b", "c", "d"]', () => {
            it('should remove any saved progress sectionIds after the current sectionId', () => {
                ...
                // console.log(router.questionnaire.answers);

                // const router2 = qRouter(router.questionnaire);

                // console.log('#####################: ', router2.getCurrentSectionId());
