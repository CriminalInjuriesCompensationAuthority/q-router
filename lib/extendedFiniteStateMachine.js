...
const operatorNoCascade = require('./operators/operatorNoCascade');
...
const operatorDateGreaterThanTwoDays = require('./operators/operatorDateGreaterThanTwoDaysAgo');

jr.addOperator('answeredLessThan', operatorAnsweredLessThan, true);
jr.addOperator('noCascade', operatorNoCascade, true);
...
jr.addOperator('dateGreaterThanTwoDays', operatorDateGreaterThanTwoDays);
