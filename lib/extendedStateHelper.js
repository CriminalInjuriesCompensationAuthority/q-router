...
function createExtendedState(spec) {
    function setupParallelMachines() {
        ...
        tasks.forEach(task => {
            ...
            taskSpec.answers = superSpec.answers;
        ...
        superSpec.events = superSpec.events || [];
        superSpec.answers = superSpec.answers || [];
    ...
    function rebuildRoutes(superRouterSpec, taskMachines) {
