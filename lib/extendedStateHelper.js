...
function createExtendedState(spec) {
    ...
    function getSystemAnswers() {
        ...
        ['system', 'owner', 'origin'].forEach(systemAnswer => {
            if (spec.answers && systemAnswer in spec.answers) {
    ...
    function persistContext() {
        ...
        routes.states.forEach(task => {
            ...
            currentTask.status = taskMachines[currentTask.id].last().context.status;
            currentTask.answers = taskMachines[currentTask.id].last().context.answers;
            currentTask.events = taskMachines[currentTask.id].last().context.events;
        });
        return routes;
    }
