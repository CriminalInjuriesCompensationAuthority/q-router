...
function superRouter(spec) {
    ...
    function isAvailable(id) {
        ...
        if (id in superRouterSpec.routes) {
            ...
            // Return true if the task is actionable
    ...
    function setCurrent(currentId) {
        ...
        // If the Id is a task
        if (currentId in superRouterSpec.routes) {
            // Set to initial question of the task
            superRouterSpec.currentSectionId = superRouterSpec.routes[currentId].first().id;
            return {
    ...
    function nextTask(taskId) {
        // If the task is in the `notApplicable` state.
