...
function Machine(spec) {
    const {
        states,
        evaluateCondition = (cond, extendedStateObject, eventObject, stateId) => {
            console.log('@@@@@@@@@@@@@@@@@@@@: ', cond, extendedStateObject, eventObject, stateId);
    ...
    function transition(currentState, event, extendedState) {
        ...
        if ('on' in state) {
            ...
            if (Array.isArray(target)) {
                ...
                const index = targets.findIndex(element =>
